...
public class ConeAuto extends SequentialCommandGroup {
    public ConeAuto(DriveSubsystem drive, ArmSubsystem arm, IntakeSubsystem intake, double armExtendTime, double autoThrowTime, double autoDriveTime, double armOutputPower, int intakeCurrentLimit, double autoDriveSpeed, double intakeOutputPower) {
        addCommands(
